...
class ConversionsTest < Minitest::Test
  ...
  def test_multiple_conversions
    ...
    assert_equal_scores 'speaker', { conversions: %w[conversions_a conversions_b] }, Speaker
    assert_equal_scores 'speaker', { conversions: %w[conversions_b conversions_a] }, Speaker
  ...
  def test_multiple_conversions_with_boost_term
    ...
    assert_order 'speaker', ['Speaker A', 'Speaker B', 'Speaker C', 'Speaker D'], { conversions: 'conversions_a' },
                 Speaker
    assert_order 'speaker', ['Speaker D', 'Speaker C', 'Speaker B', 'Speaker A'],
                 { conversions: 'conversions_a', conversions_term: 'speaker_1' }, Speaker
  end
