...
class BoostTest < Minitest::Test
  ...
  def test_fields
    ...
    assert_order 'red', %w[Red White], fields: ['name^10', 'color']
  end
  ...
  def test_fields_decimal
    ...
    assert_order 'red', %w[Red White], fields: ['name^10.5', 'color']
  end
  ...
  def test_fields_word_start
    ...
    assert_order 'red', %w[Red White], fields: [{ 'name^10' => :word_start }, 'color']
  end
  ...
  def test_boost_by_indices
    ...
    assert_order 'Rex', %w[Rexx Rex], { models: [Animal, Product], indices_boost: { Animal => 1, Product => 200 }, fields: [:name] }, Openkick
  end
end
